...
using sattec.Identity.Application.Users.Commands.BankAccountInformation;
...
public class SignController : ApiControllerBase
{
    ...
    [Route("BankAccount"), HttpPost]
    public async Task<ActionResult<Result>> BankAccount(BankAccountCommand command)
    {
        return await Mediator.Send(command);
    }
