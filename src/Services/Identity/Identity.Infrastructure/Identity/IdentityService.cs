...
public class IdentityService : IIdentityService
{
    ...
    public async Task<Result> createBankInfo(string userId, bool isDefaultAccount, Guid bankId, string title, string accountNo, string cardNo, string iban, string accountName, string description)
    {
        var user = _userManager.Users.Where(u => u.Id == userId).SingleOrDefault();
